...
const ThumbnailCart = ({ item, keyy }) => {
  ...
  return (
    <div className="flex items-center w-fit justify-evenly">
      {item.images ? (
        <Image
          src={item.images[0]}
          alt=""
      ...
      <div className="pl-2 w-fit">
        <h1 className="font-bold min-w-fit">{item.name}</h1>
        <p>Price: {item.price}$</p>
      </div>
      <div
        className=" btn btn-circle ml-2 btn-secondary btn-sm"
